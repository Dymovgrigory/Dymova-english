#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Обновить блок «Наши преимущества» (#fxb-adv, recordid 2422570311)
на главной (pageid 151210576) из fxb_dir.html и опубликовать страницу."""
import asyncio, os
...
BLOCKS = [("2422570311", "fxb_dir.html")]  # #fxb-dir
