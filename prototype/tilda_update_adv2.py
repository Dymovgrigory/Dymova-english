#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Обновить блок «Наши преимущества» (#fxb-adv, recordid 2422572521)
на главной (pageid 151210576) из fxb_adv_v2.html и опубликовать страницу."""
import asyncio, os
...
BLOCKS = [("2422572521", "fxb_adv_v2.html")]  # #fxb-adv
