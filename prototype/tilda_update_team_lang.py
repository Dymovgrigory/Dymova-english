#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Обновить блоки «Команда» (#fxb-team) и «Другие языки» (#fxb-lang)
на главной (/index-new, pageid 151210576) реальными фото и видеовизитками,
затем опубликовать страницу. Recordid определяются динамически по id блока."""
import asyncio, os
...
BLOCKS = [
    ("2422572491", "tilda_team.html"),       # #fxb-team
    ("2422572511", "tilda_languages.html"),  # #fxb-lang
]
