...
Каждая доп. страница собирается из 3 фрагментов:
  1) block_shapka.html  — общая шапка/меню (одинаковая на всех страницах)
  2) <этот блок>         — контент, релевантный конкретной странице
  3) block_footer.html  — общий подвал
...
#fxb-page .fxb-book h3{font-size:15.5px;font-weight:800;margin-bottom:6px}
...
/* Аудит 85c: широкие таблицы выходили за экран на мобильных — горизонтальный
   скролл всей страницы. Даём таблице собственную прокрутку. */
@media(max-width:640px){#fxb-page.fxb-blog-page .fxb-article-body table{display:block;overflow-x:auto;-webkit-overflow-scrolling:touch}}
...
PAGES["page_doshkolniki.html"] = {
    ...
    "facts": [
        ...
        ("clock", "45–60 минут", "2–3 года — 45 минут, 4–6 лет — 60 минут"),
        ("sun", "Утро, день и вечер", "Группы в течение всего дня — удобно и после сада"),
        ("group", "До 7 человек", "Камерные группы по возрасту и уровню"),
    ],
    "faq_title": "Частые вопросы про английский для дошкольников",
    "faq": [
        ("Со скольких лет принимаете детей?", "Набираем детей от 2 лет: малыши 2–3 лет занимаются по 45 минут, группы 4–6 лет — по 60 минут, 2 раза в неделю."),
        ("Ребёнок ещё не читает и не пишет — как он будет учить язык?", "В этом возрасте чтение и письмо и не нужны: учим через песни, подвижные игры и творчество. Занятие полностью на английском, ребёнок привыкает к языку естественно."),
        ("Есть ли занятия после детского сада?", "Да, есть утренние, дневные и вечерние группы — ребёнок успевает прийти после сада. Точное расписание подберём на диагностике."),
        ("По какой программе занимаетесь?", "По авторской программе руководителя школы, адаптированной для дошкольников: первый год Starter (3–5 лет), второй год Pre-A1 (5–6 лет)."),
    ],
    "video": {
        "kicker": "Видео",
    ...
    "prices": True,
    "price_cards": [
        ("Группа 4–6 лет", "", '9 000 ₽<span>/мес</span>', "2 занятия в неделю · 60 минут · мини-группа"),
        ("Малыши 2–3 года", "", '7 000 ₽<span>/мес</span>', "2 занятия в неделю · 45 минут · мини-группа"),
        ("Индивидуально", " fxb-price-tag--orange", '2 500 ₽<span>/час</span>', "Индивидуальный темп и гибкий график"),
        ("Пробный урок", "", "1 125 ₽", "Знакомство с педагогом и подбор формата"),
    ],
    "extra_sections": [
    ...
    "ladder_title": 'Пособия и <span class="fxb-accent">материалы</span>',
    "ladder_lead": "Используем авторскую программу руководителя школы, адаптированную для дошкольного возраста. Дорожные карты обучения на учебный год — открывайте и смотрите подробно.",
    "ladder": [
        {"group":"Авторская программа · дошкольники", "items":[
           ("Дошкольники 3–5 лет", "Первый год обучения · Starter", ROADMAP+"preschool-3-5.webp"),
           ("Дошкольники 5–6 лет", "Второй год обучения · Pre-A1", ROADMAP+"preschool-5-6.webp"),
        ]},
    ],
...
PAGES["page_mladshie_shkolniki.html"] = {
    ...
    "teachers": ENGLISH_TEACHERS,
    "prices": True,
    "faq_title": "Частые вопросы про английский для младших школьников",
    "faq": [
        ("Ребёнок учится во вторую смену — подберёте время?", "Да, есть утренние, дневные и вечерние группы — найдём удобное расписание при любой школьной смене."),
        ("Английский в школе только начался, не будет ли сложно?", "Нет: для 1–4 классов у нас уровни My level 1–4 и Super Minds 1–4, программа идёт параллельно школьной и закрывает пробелы."),
        ("Научите ребёнка читать по-английски?", "Да, чтению учим по правилам phonics: ребёнок понимает, как буквы складываются в слова, а не зубрит написание."),
        ("Как вы будете показывать нам прогресс?", "Группируем детей по уровню, а не только по классу, и даём регулярную обратную связь родителям после занятий."),
    ],
...
PAGES["page_podrostki.html"] = {
    ...
    "facts": [
        ...
        ("sun", "Утро, день и вечер", "Группы в течение дня — удобно и во вторую смену"),
    ...
    "extra_sections": [
        ...
        "<h2>Английский по классам: с 5 по 9 класс</h2>"
        "<p>Школьная программа по английскому заметно усложняется каждый год — и мы подкрепляем её на каждой ступени:</p>"
        "<ul>"
        "<li><b>5 класс</b> — переход в среднее звено: систематизируем грамматику (Present Simple/Continuous, артикли), учим работать с текстами и говорить по темам школьной программы.</li>"
        "<li><b>6 класс</b> — наращиваем словарный запас и чтение, разбираем Past Simple и конструкции будущего времени, готовим к первым ВПР.</li>"
        "<li><b>7 класс</b> — условные предложения, пассивный залог, развёрнутые монологи: выходим на уверенный A2.</li>"
        "<li><b>8 класс</b> — академический английский: эссе, аргументация, все времена системно. Фундамент для ОГЭ.</li>"
        "<li><b>9 класс</b> — полная подготовка к ОГЭ: все разделы экзамена, устная часть, пробники в реальном формате (<a href=\"/oge-anglijskij\">подробнее про подготовку к ОГЭ</a>).</li>"
        "</ul>"
        "<p>Группы формируются по уровню, а не только по классу: на бесплатной диагностике определим точку старта и подберём группу, где подросток будет расти быстрее школьной программы.</p>"
        "</div></div></section>",
    ],
    "has_video_story": True,
    "faq_title": "Частые вопросы про английский для подростков",
    "faq": [
        ("Подтягиваете школьную программу по классам?", "Да. Работаем со школьниками 5–9 классов: программа занятий идёт параллельно со школьной и опережает её — от грамматики 5 класса до полной подготовки к ОГЭ в 9 классе."),
        ("В каком классе начинать дополнительный английский?", "Лучше всего — в 5–6 классе, когда школьная программа ещё даёт время на базу: счёт, грамматика и разговорная уверенность наращиваются без гонки. В 8–9 классе фокус смещается на ОГЭ, поэтому чем раньше старт, тем спокойнее подготовка."),
        ("Сколько стоят занятия для подростков?", "Мини-группа до 7 человек — от 9 000 ₽ в месяц (2 занятия в неделю по 60 минут). Индивидуальные занятия — 2 500 ₽/час. Первый шаг — бесплатная диагностика уровня."),
        ("А если английский в школе идёт плохо?", "Начнём с диагностики: найдём пробелы (обычно это грамматика и аудирование) и закроем их в мини-группе по уровню, а не по классу."),
        ("Готовите ли к ОГЭ и ЕГЭ?", "Да, есть отдельные программы: <a href=\"/oge-anglijskij\">подготовка к ОГЭ</a> для 9 класса и <a href=\"/ege-anglijskij\">подготовка к ЕГЭ</a> для 10–11 классов."),
        ("Сколько человек в группе?", "До 7 человек, группы по уровню и целям. Есть и индивидуальные занятия с педагогом."),
    ],
...
PAGES["page_letnyaya_akademiya.html"] = {
    ...
    "eyebrow": "Летние программы · как это было летом 2026",
    "h1": 'Летняя <span class="fxb-accent">Академия</span>',
    "sub": "Интенсив прошёл летом 2026: развивали английский, не теряя форму. Игры, проекты и общение — без скучных уроков. Запись на Летнюю Академию 2027 откроется в июне 2027.",
    "cta_label": "Оставить заявку на 2027",
    "feat_kicker": "Программа",
    "feat_title": "Что входило в программу",
    ...
    "features": [
        ...
        ("rocket", "Творческие проекты", "Презентации, мини-спектакли и видеоблоги — язык применялся в реальных задачах."),
        ("group", "Мини-группы до 7", "Формировали по уровню и возрасту — максимум практики для каждого."),
        ("sun", "Первая половина дня", "Свободный день у ребёнка оставался — занятия проходили утром."),
    ],
    "facts_title": "Как это было летом 2026",
    "facts": [
        ("calendar", "2–4 недели", "Длилась каждая смена"),
        ("clock", "Утро", "Занятия шли в первой половине дня"),
        ("group", "До 7 человек", "Группы по возрасту и уровню"),
        ("target", "Без потери формы", "Уровень поддержали за лето"),
    ],
    "faq_title": "Частые вопросы про Летнюю Академию",
    "faq": [
        ("Когда откроется запись на следующее лето?", "Запись на Летнюю Академию 2027 откроется в июне 2027. Оставьте заявку — напомним о старте и покажем расписание смен."),
        ("Сколько стоила смена летом 2026?", "Смена стоила 26 000 ₽ плюс питание. Актуальную стоимость 2027 года объявим при открытии записи."),
        ("Как долго длилась смена?", "Каждая смена шла 2–4 недели, занятия проходили в первой половине дня — вторая половина оставалась свободной."),
        ("Сколько детей было в группе?", "До 7 человек: группы формировали по возрасту и уровню, чтобы у каждого было максимум разговорной практики."),
    ],
    "video": {
        "kicker": "Как это было",
        "title": 'Летняя Академия — <span class="fxb-accent">вживую</span>',
        "lead": "Атмосфера смены: как проходили занятия, проекты и общение в Академии.",
    ...
    "lead_hero_window": "Блок героя · заявка 2027",
    "lead_final_window": "Финальный блок · заявка 2027",
    "cta_title": 'Оставьте заявку на <span class="fxb-accent">Летнюю Академию 2027</span>',
...
PAGES["page_podderzhivayushchie_online.html"] = {
    ...
    "sub": "Лёгкий формат, чтобы не забыть выученное за лето. Повторяем, закрепляем и поддерживаем уровень. Летний формат — запись откроется в июне 2027.",
    "cta_label": "Оставить контакты",
    ...
    "prices": True,
    "faq_title": "Частые вопросы про поддерживающий формат",
    "faq": [
        ("Чем этот формат отличается от обычных занятий?", "Это лёгкий летний формат: 1–2 раза в неделю по 45 минут, без домашнего перегруза. Цель — не забыть выученное и вернуться в форму к сентябрю."),
        ("Что происходит на занятиях?", "Повторяем и закрепляем пройденное, главный акцент — разговорная практика: ребёнок продолжает использовать язык, а не зубрить правила."),
        ("Когда можно будет записаться?", "Это летний формат — запись откроется в июне 2027. Оставьте контакты, и мы напомним о старте."),
        ("Есть ли пробное занятие?", "Да, пробный урок стоит 1 125 ₽: знакомство с педагогом и подбор подходящей мини-группы по уровню."),
    ],
    "price_cards": [
        ("Группа", "", '9 000 ₽<span>/мес</span>', "1–2 занятия в неделю · 45 минут · мини-группа"),
        ("Индивидуально", " fxb-price-tag--orange", '2 500 ₽<span>/час</span>', "Индивидуальный темп и гибкий график"),
        ("Пробный урок", "", "1 125 ₽", "Знакомство с педагогом и подбор формата"),
    ],
    ...
    "lead_hero_window": "Блок героя",
    "lead_final_window": "Финальный блок",
    "cta_title": 'Поддержите уровень <span class="fxb-accent">следующим летом</span>',
    "cta_text": "Оставьте контакты — напомним о старте записи на летний формат 2027.",
}
...
PAGES["page_standartnye_offline.html"] = {
    ...
    "features": [
        ...
        ("sun", "Утро, день и вечер", "Группы в течение всего дня — удобно и тем, кто во вторую смену."),
    ],
    "facts_title": "Коротко о занятиях",
    "facts": [
    ...
    "prices": True,
    "faq_title": "Частые вопросы про занятия в филиале",
    "faq": [
        ("Где находятся филиалы?", "Оба филиала — в Долгопрудном: Лихачёвский проспект, 76к1 и Ракетостроителей, 9к3. Выбирайте тот, что ближе к дому."),
        ("Ребёнок учится во вторую смену — есть занятия утром?", "Да, есть утренние, дневные и вечерние группы — удобно и тем, кто учится во вторую смену."),
        ("Сколько человек в группе и как часто занятия?", "Мини-группы до 7 человек по уровню, занятия 2 раза в неделю по 60 минут."),
        ("Чем оффлайн лучше онлайна?", "Живое общение, игры и работа в парах — язык усваивается через взаимодействие, а педагог видит каждого и сразу исправляет ошибки."),
    ],
...
PAGES["page_reading.html"] = {
    ...
    "teachers": ENGLISH_TEACHERS,
    "prices": True,
    "faq_title": "Частые вопросы про курс чтения",
    "faq": [
        ("Для кого этот курс?", "Для младших школьников: интенсив на летние месяцы, старт 1 июня. Программа разработана методистами школы на основе школьной."),
        ("Ребёнок вообще не читает по-английски — подойдёт?", "Да, ведём с нуля по правилам phonics: буквы и звуки → слоги → слова → предложения → короткие тексты. К концу курса — уверенное чтение."),
        ("Сколько стоит курс?", "9 000 ₽ в месяц, мини-группы до 7 человек по уровню, без перехода на русский на занятии."),
        ("Как мы увидим результат?", "Еженедельные видео-отчёты, открытые уроки и тестирования — прогресс ребёнка виден родителям на каждом этапе."),
    ],
...
PAGES["page_grammar.html"] = {
    ...
    "teachers": ENGLISH_TEACHERS,
    "prices": True,
    "faq_title": "Частые вопросы про курс грамматики",
    "faq": [
        ("Для каких классов рассчитан курс?", "Для учеников 3–8 классов — для тех, кто путается во временах, не понимает правил или не может применить их на практике."),
        ("Ребёнок «зубрит» правила, но не применяет их — это про него?", "Да. Мы объясняем грамматику как систему: просто и логично, с практикой до автоматизма — в речи и письме, а не только в упражнениях."),
        ("Успеете ли закрыть пробелы за лето?", "Курс интенсивный и идёт именно перед учебным годом: на диагностике находим слабые темы и подтягиваем их в мини-группе до 7 человек."),
        ("Сколько стоит курс?", "9 000 ₽ в месяц. Начать стоит с бесплатной диагностики — определим пробелы и составим план занятий."),
    ],
...
PAGES["page_nedelya_znakomstva.html"] = {
    ...
    "facts": [
        ...
        ("group", "5 направлений", "Английский, китайский, немецкий, испанский, подготовка к школе"),
    ],
    "formats_kicker": "Направления",
    "formats_title": "Выберите, что попробовать",
    "formats_lead": "Пробное занятие можно взять по любому из пяти направлений.",
    "formats": [
        ...
        ("globe", "Испанский язык", "Фонетика близка к русской: читается как пишется, "
                                    "и заговорить получается быстрее, чем на других языках.",
         ("Попробовать", "Неделя знакомства — Испанский язык")),
    ...
    "faq": [
        ...
        ("Какие направления можно попробовать?",
         "Английский, китайский, немецкий и испанский языки, а также подготовку к школе — одно направление на выбор."),
...
PAGES["page_preparation.html"] = {
    ...
    "sub": "Готовим дошкольников 5–7 лет к первому классу, занимаемся со школьниками 1–4 классов и помогаем с подготовкой к ОГЭ, ЕГЭ и ВПР.",
    ...
    "features": [
        ("star", "Подготовка к школе", "Для детей 5–6 и 6–7 лет: чтение, счёт, логика, речь и усидчивость."),
    ...
    "faq_title": "Частые вопросы про подготовку к школе",
    "faq": [
        ("Что входит в подготовку к школе?", "Чтение, счёт и основы математики, русский язык (речь, звуки, письмо), логика и усидчивость — комплексно, в мини-группах."),
        ("Есть ли занятия по математике и русскому языку?", "Да. Помимо английского ведём подготовку по математике и русскому языку для дошкольников и помогаем школьникам 1–4 классов с этими предметами."),
...
PAGES["page_geo_mytishchi.html"] = {
    ...
    "sub": "Языковая школа Фоксинбург в Долгопрудном — у самой границы с Мытищами. Подготовка к школе, английский и другие языки для детей и взрослых из Мытищ.",
    "cta_label": "Записаться на диагностику",
    "feat_kicker": "Почему мы",
    "feat_title": "Школа рядом с границей Мытищ",
    "feat_lead": "Долгопрудный и Мытищи — соседние города: до наших филиалов удобно добираться из районов Мытищ, граничащих с Долгопрудным.",
    "features": [
        ("compass", "Филиал у границы с Мытищами", "Лихачёвский проспект, 76к1 — ближайший к Мытищам филиал: на машине или транспортом по Лихачёвскому проспекту."),
    ...
    "facts_title": "Коротко",
    "facts": [
        ("compass", "2 филиала", "Один — у границы с Мытищами"),
        ("group", "до 7 человек", "Мини-группы по уровню"),
    ...
    "teachers": ENGLISH_TEACHERS,
    "prices": True,
    "price_title": "Стоимость для семей из Мытищ",
    ...
    "extra_sections": [
        ...
        '<section class="fxb-section"><div class="fxb-wrap"><div class="fxb-article-body">'
        "<h2>Программы для детей из Мытищ</h2>"
        "<p>Чаще всего из Мытищ к нам приезжают на подготовку к школе и английский для детей — оба направления идут в мини-группах очно, а при нехватке времени на дорогу доступны онлайн-форматы:</p>"
        "<ul>"
        ...
        "</ul>"
        "<h2>Как добраться из Мытищ</h2>"
        "<p>Фоксинбург находится в Долгопрудном — городе, который напрямую граничит с Мытищами. Из районов Мытищ у границы с Долгопрудным до наших филиалов удобно добираться на автомобиле или городским транспортом:</p>"
        "<ul>"
        '<li><b>Лихачёвский проспект, 76к1</b> — ближайший к Мытищам филиал, на Лихачёвском проспекте по пути от Мытищ. <a href="' + YANDEX_MAPS_LIHACHEVSKY + '" target="_blank" rel="noopener">Построить маршрут на Яндекс.Картах</a>;</li>'
        '<li><b>Проспект Ракетостроителей, 9к3</b> — второй филиал, рядом с МФТИ. <a href="' + YANDEX_MAPS_RAKETOSTROITELEY + '" target="_blank" rel="noopener">Построить маршрут на Яндекс.Картах</a>.</li>'
        "</ul>"
    ...
    "faq_title": "Частые вопросы от семей из Мытищ",
    "faq": [
        ("Вы принимаете детей из Мытищ?", "Да. Долгопрудный граничит с Мытищами, и к нам уже ездят семьи из соседних районов. Филиал на Лихачёвском проспекте, 76к1 — ближайший к границе с Мытищами."),
        ...
        ("Какой филиал удобнее из Мытищ?", "Чаще всего удобнее филиал на Лихачёвском проспекте, 76к1 — он на пути от Мытищ. Но расписание групп различается: подберём удобный вариант на диагностике."),
    ...
    "extra_jsonld": [
        course_jsonld(
            "Подготовка к школе и английский рядом с Мытищами — Фоксинбург",
            "Подготовка к школе (чтение, математика, русский язык) и английский для детей из Мытищ в языковой школе Фоксинбург в Долгопрудном: филиал у границы с Мытищами, мини-группы до 7 человек, бесплатная диагностика.",
            SITE + "/geo/mytishchi",
        ...
        breadcrumb_jsonld([
            ("Главная", SITE + "/"),
            ("Рядом с Мытищами", SITE + "/geo/mytishchi"),
        ]),
    ],
    "lead_subject": "Запись из Мытищ (geo-страница)",
    "lead_hero_window": "Блок героя",
    "lead_final_window": "Финальный блок",
    "cta_title": 'Запишитесь на <span class="fxb-accent">бесплатную диагностику</span>',
    "cta_text": "Определим уровень и цель, подберём программу и удобный филиал — для семей из Мытищ и Долгопрудного.",
}
...
PAGES["page_anglijskij_dlya_vzroslyh.html"] = {
    ...
    "features": [
        ...
        ("clock", "Удобное время", "Утренние, дневные и вечерние группы под рабочий график, а также онлайн-формат."),
    ...
    "formats": [
        ...
        ("chat", "Индивидуальные занятия (репетиторский формат)", "Личная программа под вашу цель, гибкий график, очно или онлайн. 2 500 ₽/час — как с репетитором, но по методике школы."),
    ],
    "teachers": ENGLISH_TEACHERS,
    "prices": True,
    ...
    "faq": [
        ...
        ("Подойдёт ли курс для работы и путешествий?", "Да. Программа подстраивается под цель: английский для работы (письма, звонки, собеседования) и английский для путешествий (аэропорт, отель, общение в поездке) — скажите цель на диагностике, и мы выстроим маршрут. Какие фразы пригодятся в поездке — в статье «<a href=\"/blog-anglijskij-dlya-puteshestvij\">Английский для путешествий: базовые фразы и лайфхаки</a>»."),
        ("Не поздно ли начинать учить английский во взрослом возрасте?", "Не поздно ни в 30, ни в 60 лет. Взрослые понимают систему языка быстрее детей, а в мини-группе никто не стесняется говорить. Отдельно разобрали обучение после 50–60 лет в статье «<a href=\"/blog-anglijskij-dlya-pensionerov\">Английский для пенсионеров: с чего начать</a>»."),
        ("В какое время занятия?", "Есть утренние, дневные и вечерние группы под рабочий график, а также онлайн-формат."),
        ...
        ("Можно заниматься индивидуально?", "Да, есть репетиторский формат: индивидуальные занятия с педагогом школы очно в Долгопрудном или онлайн, 2 500 ₽/час. Личная программа под вашу цель и гибкий график."),
    ],
...
PAGES["page_nemeckij_yazyk.html"] = {
    ...
    "sub": "Немецкий язык с нуля в Долгопрудном для детей, школьников и взрослых. Та же проверенная методика Фоксинбург — в мини-группах и с живым общением.",
...
PAGES["page_repetitor.html"] = {
    ...
    "faq": [
        ...
        ("Подходят ли индивидуальные занятия взрослым?", "Да, это основной формат для взрослых с конкретной целью: заговорить к поездке, подготовиться к собеседованию, восстановить язык после перерыва. Программа идёт под вашу задачу и график — очно или онлайн."),
...
PAGES["page_kitajskij_yazyk.html"] = {
    ...
    "faq": [
        ...
        ("Для какого возраста курсы?", "Для детей, школьников и взрослых. Группы подбираем по возрасту и уровню."),
        ("Есть ли китайский для взрослых?", "Да. Китайский для взрослых — отдельные группы с нуля: тоны, иероглифика и разговорная практика в комфортном темпе, очно или онлайн."),
        ("Занятия очно или онлайн?", "Есть оба формата: очно в Долгопрудном (два филиала рядом с МФТИ) и онлайн."),
        ("Можно оплатить материнским капиталом?", "Да. Занятия можно оплатить материнским капиталом и вернуть 13% стоимости налоговым вычетом."),
...
# Их нет на живом сайте и в seo_meta_live.json — title/description
...
PAGES["page_vpr_anglijskij.html"] = {
    ...
    "extra_jsonld": [
        course_jsonld(
            ...
            "Подготовка к ВПР по английскому (4–8 классы) в Долгопрудном: разбор формата, отработка разделов, пробные работы. Очно в двух филиалах или онлайн.",
            SITE + "/vpr-anglijskij",
...
PAGES["page_razgovornyj_anglijskij.html"] = {
    ...
    "faq": [
        ...
        ("Сколько стоит разговорный курс?", "Групповые занятия — от 9 000 ₽ в месяц (2 раза в неделю), индивидуальные — 2 500 ₽/час. Начинается всё с бесплатной диагностики уровня."),
...
PAGES["page_vesennyaya_akademiya_2026.html"] = {
    ...
    "extra_sections": [
        ...
        (
            ...
            '<h2 class="fxb-h2">Запись на программы нового учебного года открыта</h2>'
            '<p class="fxb-lead">Выбирайте курс по возрасту и цели — или оставьте заявку, и мы подберём формат.</p></div>'
            '<p style="display:flex;gap:12px;flex-wrap:wrap">'
            '<a class="fxb-btn-main" href="/tseny">Цены и программы</a>'
            '<a class="fxb-btn-main" href="/ekskursii">Экскурсии: Ю-Клиника и пожарная станция</a>'
...
PAGES["page_test_uroven.html"] = {
    ...
    "extra_jsonld": [
        webpage_jsonld(
            ...
            "Бесплатный онлайн-тест уровня английского от Фоксинбурга: 15 вопросов A1–B1+, мгновенный результат и рекомендация программы. Очно в Долгопрудном и онлайн.",
            SITE + "/test-uroven",
        ),
        breadcrumb_jsonld([
            ("Главная", SITE + "/"),
...
PAGES["page_test_gotov_k_shkole.html"] = {
    ...
    "extra_jsonld": [
        webpage_jsonld(
            ...
            "Бесплатный тест готовности ребёнка к школе: 12 вопросов по вниманию, речи, моторике и самостоятельности. Результат и рекомендации сразу.",
...
PAGES["page_test_format.html"] = {
    ...
    "extra_jsonld": [
        webpage_jsonld(
            ...
            "Бесплатный квиз Фоксинбурга: 7 вопросов — и вы знаете, какой формат подойдёт: мини-группа в Долгопрудном, индивидуально, онлайн или интенсив. С ценами.",
            SITE + "/test-format",
        ),
        breadcrumb_jsonld([
            ("Главная", SITE + "/"),
...
def make_words_page(page_key, alias, slug, theme_ru, theme_ru_rod, h1, sub, description, words, hero_grad, programs, faq_extra=None):
    other_topics = [
    ...
    PAGES[page_key] = {
        ...
        "faq": [
            ...
            ("Как быстро выучить эти слова с ребёнком?",
             "По 5–7 слов в день с обязательным повтором вчерашних, слово называть вслух и сразу вставлять в предложение про свою жизнь. Подробная методика и план на неделю — в статье «<a href=\"/blog-slova-po-temam\">Английские слова по темам: как учить словарь с ребёнком</a>»."),
...
make_words_page(
    ...
    "Английские слова на тему «Животные» с транскрипцией и переводом: 30 слов уровня A1 с примерами предложений. Бесплатный словарь для детей.",
    WORDS_ZHIVOTNYE,
...
make_words_page(
    ...
    "Английские слова на тему «Еда» с транскрипцией и переводом: 29 слов уровня A1 с примерами предложений. Бесплатный словарь для детей.",
    WORDS_EDA,
    "linear-gradient(135deg,#2b1f14 0%,#5a4426 55%,#8a6a35 100%)",
    [("/doshkolniki", "Дошкольникам"), ("/mladshie-shkolniki", "Младшим школьникам")],
    faq_extra=[
        ("Как на английском сказать «я пью воду» и другие фразы про еду?",
         "I drink water — я пью воду, I eat soup — я ем суп, I like apples — мне нравятся яблоки. Слова темы складываются в такие простые фразы сразу — собрали их в статье «<a href=\"/blog-frazy-na-anglijskom-dlya-detej\">Фразы на английском для детей: еда, вода, школа</a>»."),
    ],
)
make_words_page(
    ...
    "Английские слова на тему «Школа» с транскрипцией и переводом: 29 слов уровня A1 с примерами предложений. Бесплатный словарь для школьников.",
    WORDS_SHKOLA,
    "linear-gradient(135deg,#161f2e 0%,#243a5e 55%,#3a5f9e 100%)",
    [("/mladshie-shkolniki", "Младшим школьникам"), ("/podrostki", "Подросткам")],
    faq_extra=[
        ("Какие школьные слова нужны к 1 сентября?",
         "Минимум — предметы (school, pen, book), действия (read, write, listen) и фразы-инструкции (Open your books, Stand up). К ним — готовые фразы для урока в статье «<a href=\"/blog-frazy-na-anglijskom-dlya-detej\">Фразы на английском для детей</a>»."),
    ],
)
make_words_page(
    ...
    "Английские слова на тему «Семья» с транскрипцией и переводом: 33 слова уровня A1 с примерами предложений. Бесплатный словарь для детей.",
    WORDS_SEMA,
...
make_words_page(
    ...
    "Английские слова на тему «Цвета» с транскрипцией и переводом: 25 слов уровня A1 с примерами предложений. Бесплатный словарь для детей.",
    WORDS_TSVETA,
...
PAGES["page_english_words.html"] = {
    ...
    "sub": "Тематические подборки английских слов с транскрипцией, переводом и примерами: животные, еда, школа, семья, цвета, профессии, одежда, погода, транспорт, дом, спорт, путешествия, время и числа, хобби, природа и праздники. Уровень A1 — идеально для старта.",
    "cta_label": "Бесплатная диагностика",
    "feat_kicker": "Как это работает",
    ...
    "features": [
        ("book", "16 тем, 460+ слов", "Животные, еда, школа, семья, цвета, профессии, одежда, погода, транспорт, дом, спорт, путешествия, время и числа, хобби, природа и праздники — базовая лексика уровня A1 с переводом."),
    ...
    "extra_sections": [
        ...
        '<li><a href="/english-words/eda"><b>Еда</b></a> — 30 слов: от bread и milk до pizza и ice cream;</li>'
        '<li><a href="/english-words/shkola"><b>Школа</b></a> — 29 слов: от pen и book до timetable и homework;</li>'
        '<li><a href="/english-words/semya"><b>Семья</b></a> — 33 слова: от mum и dad до niece и grandson;</li>'
        ...
        '<li><a href="/english-words/puteshestviya"><b>Путешествия</b></a> — 28 слов: от ticket и train до suitcase и passport;</li>'
        '<li><a href="/english-words/vremya-i-chisla"><b>Время и числа</b></a> — 28 слов: от time и clock до hundred и thousand;</li>'
        '<li><a href="/english-words/hobbi"><b>Хобби</b></a> — 26 слов: от reading и drawing до chess и photography;</li>'
        '<li><a href="/english-words/priroda"><b>Природа</b></a> — 26 слов: от tree и flower до rainbow и island;</li>'
        '<li><a href="/english-words/prazdniki"><b>Праздники</b></a> — 25 слов: от birthday и party до fireworks и carnival.</li>'
        "</ul>"
    ...
    "extra_jsonld": [
        webpage_jsonld(
            ...
            "Тематический словарь английских слов для детей с транскрипцией и примерами: животные, еда, школа, семья, цвета. Уровень А1, бесплатно.",
            SITE + "/english-words",
        ),
        breadcrumb_jsonld([
            ("Главная", SITE + "/"),
...
NEWS_POST_1 = {
    ...
    "title": "Со скольки лет учить английский ребёнку: гид 2026",
    "description": "Узнайте, со скольки лет начинать английский с ребёнком: что даёт ранний старт, как подать язык без стресса и когда переходить к групповым занятиям.",
    ...
    "body": [
        ...
        ("p", "Есть несколько простых признаков: ребёнок с удовольствием повторяет слова и рифмовки, спокойно воспринимает короткие инструкции на слух, любит карточки, песенки и настольные игры, а ещё готов приходить на занятие без длительной адаптации. Это хороший момент, чтобы попробовать регулярный формат. Для младших школьников уже можно переходить к более структурной базе — чтению, письму, словарю и первым грамматическим моделям. В этом хорошо помогают наши <a href=\"/mladshie-shkolniki\">занятия для младших школьников</a>. А быстро сориентироваться по текущей базе поможет <a href=\"/test-uroven\">бесплатный онлайн-тест уровня</a> — он займёт пару минут."),
...
NEWS_POST_2 = {
    ...
    "title": "Как подготовиться к ОГЭ по английскому в 2026: план",
    "description": "Выстройте спокойную подготовку к ОГЭ по английскому на 2026/27 год: сроки старта, тренировка всех разделов, типичные ошибки и план без паники.",
    "category": "Экзамены",
    "date": "2025-06-20",
    ...
    "body": [
        ...
        ("p", "Если подойти к экзамену спокойно и последовательно, результат обычно чувствуется не только в баллах. У ребёнка появляется уверенность: он знает, как читать задания, как распределять время, как отвечать устно и как не теряться в письме. Это и есть настоящая подготовка — когда ученик не просто «натаскан», а умеет действовать по плану. Первый шаг удобно сделать прямо сейчас: пройдите <a href=\"/test-uroven\">бесплатный тест уровня</a> — по итогам будет понятно, какой балл ребёнок набрал бы сегодня."),
    ],
    "related": [
...
NEWS_POST_3 = {
    ...
    "title": "Летняя Академия 2026: как проходят смены в Фоксинбурге",
    "description": "Посмотрите, как устроены смены Летней Академии в Фоксинбурге: тематические недели, мини-проекты, мини-группы и комфортный утренний формат занятий.",
    ...
    "body": [
        ...
        ("p", "Подробнее о самом направлении можно посмотреть на странице <a href=\"/letnyaya-akademiya\">Летней Академии</a>. А если хочется быть в курсе школьных новостей и полезных материалов, заглядывайте в <a href=\"/novosti\">новости и статьи</a> — там мы собираем короткие разборы, ответы на частые вопросы и рассказы о наших программах. Это удобный способ не потерять летний настрой и выбрать следующий шаг заранее. Актуальное расписание групп на учебный год — на странице <a href=\"/raspisanie\">расписания</a>."),
    ],
    "related": [
...
NEWS_POST_4 = {
    ...
    "title": "Второй язык ребёнку: немецкий или китайский — как выбрать",
    "description": "Выберите второй иностранный язык ребёнку без перегрузки: когда подключать, чем немецкий проще китайского после английского и на что смотреть родителям.",
    "category": "Полезное для родителей",
    "date": "2026-07-26",
    "reading_time": "8 минут чтения",
...
NEWS_POST_5 = {
    ...
    "title": "Английский летом 2026: как не растерять навык за каникулы",
    "description": "Сохраните английский ребёнка за летние каникулы без уроков: что слабеет первым, сколько минут практики в день достаточно и как вернуть форму к сентябрю.",
    "category": "Полезное для родителей",
    "date": "2026-07-28",
    ...
    "body": [
        ...
        ("p", "Даже если лето прошло совсем без практики, пугаться осеннего старта не стоит: знания никуда не пропадают, теряется только лёгкий доступ к ним. У большинства детей беглость и скорость речи возвращаются за первую-вторую неделю регулярных занятий — язык «просыпается» быстрее, чем кажется по первому неловкому занятию в сентябре. Хотите замерить текущий уровень после лета — пройдите <a href=\"/test-uroven\">бесплатный онлайн-тест</a>, а как удерживать язык весь год, мы разобрали в статье «<a href=\"/blog-kak-ne-poteryat-anglijskij-v-techenie-goda\">Как не потерять английский за год</a>»."),
...
NEWS_POST_6 = {
    ...
    "title": "Уровень английского у ребёнка: как проверить перед годом",
    "description": "Проверьте реальный уровень английского у ребёнка перед учебным годом: три домашних теста на 15 минут, ошибки самооценки и бесплатная диагностика.",
    ...
    "body": [
        ...
        ("p", "Ещё одна частая ловушка — смотреть только на говорение и упускать чтение и понимание на слух, хотя именно они дают более полную картину уровня. Если совместить наблюдения из трёх домашних тестов, к первому уроку у вас будет не смутное «вроде нормально», а конкретное описание: что ребёнок понимает, что может рассказать и где ему пока нужна помощь. Именно с этого мы и начинаем на <a href=\"/diagnostika\">бесплатной диагностике</a> — не с формального теста, а с спокойного разговора и заданий в игровой форме, чтобы увидеть реальную картину, а не первое волнение. Быстрый ориентир прямо сейчас даёт <a href=\"/test-uroven\">онлайн-тест уровня</a> на нашем сайте. Если уже готовы узнать, <a href=\"/novosti-zapis-na-novyj-uchebnyj-god-anglijskij-nemeckij-kitajskij\">как проходит запись на новый учебный год</a>, — рассказываем в отдельной статье."),
    ],
    "related": [
...
NEWS_POST_7 = {
    ...
    "title": "Запись на 2026/27 год: английский, немецкий и китайский",
    "description": "Запишитесь на 2026/27 учебный год в Фоксинбург: мини-группы и индивидуальные занятия по английскому, немецкому и китайскому — очно в Долгопрудном и онлайн.",
    ...
    "body": [
        ...
        ("p", "Дальше — обычная последовательность: заявка на сайте или в MAX, диагностика или пробный урок, подбор группы или индивидуального расписания, и старт занятий. Если сомневаетесь между языками или форматами — на диагностике можно обсудить это вслух, а не гадать заранее. Свежие детали и бонус ранней записи — в новости «<a href=\"/novosti-nabor-2026-2027\">Набор на 2026/27 учебный год открыт</a>»."),
...
NEWS_POST_8 = {
    ...
    "title": "Школа английского или репетитор: что выбрать в 2026 году",
    "description": "Сравните языковую школу и репетитора по задаче, а не по ценнику: когда мини-группа работает лучше, когда нужен индивидуальный формат и как их совместить.",
    "category": "Экспертное мнение",
    "date": "2026-08-04",
    "reading_time": "7 минут чтения",
...
NEWS_POST_9 = {
    ...
    "title": "Английский для взрослых с нуля: с чего начать в 2026 году",
    "description": "Начните учить английский с нуля во взрослом возрасте: честные сроки до разговорного уровня, сильные стороны взрослых учеников и план первых недель.",
    ...
    "body": [
        ...
        ("p", "Если сравнивать себя с ребёнком-полиглотом или ждать безупречной грамотности перед первой фразой — мотивация быстро гаснет. Реалистичная цель первых недель — не идеальный язык, а ощущение, что вы уже можете что-то сказать и понять. Проверить стартовую точку поможет <a href=\"/test-uroven\">бесплатный тест уровня</a>."),
...
NEWS_POST_10 = {
    ...
    "title": "Ложные друзья переводчика: 10 слов-обманок в английском",
    "description": "Разберите 10 английских слов, похожих на русские, но с другим значением: magazine, accurate, sympathy и другие ловушки из контрольных и экзаменов.",
    ...
    "body": [
        ...
        ("p", "На занятиях мы разбираем такие слова не списком для зубрёжки, а по мере того, как они реально встречаются в текстах и разговоре — так они запоминаются с первого раза, а не теряются через неделю. Если интересно, как устроены наши занятия по <a href=\"/grammar\">грамматике</a> и чтению — там таких слов встречается немало. Больше полезной лексики по темам — в нашем <a href=\"/english-words\">словаре английских слов для детей</a>, а другие похожие разборы языка ищите в разделе <a href=\"/novosti\">новостей и статей</a>."),
    ],
    "related": [
...
NEWS_POST_11 = {
    ...
    "title": "Нужен ли репетитор по английскому: 5 честных признаков",
    "description": "Зачем нужен репетитор по английскому и нужен ли он именно вашему ребёнку: 5 ситуаций, где индивидуальные занятия окупаются быстрее всего, и когда хватит мини-группы.",
    "category": "Экспертное мнение",
    "date": "2026-08-10",
    "reading_time": "6 минут чтения",
    ...
    "body": [
        ...
        ("p", "Честности ради: если ребёнок общительный, идёт вровень с программой и цель — свободно говорить и не терять интерес, мини-группа справится лучше и дешевле. В группе есть то, чего не даст ни один репетитор: живые диалоги со сверстниками, игра и лёгкое соревнование. Поэтому у нас оба формата не конкурируют, а дополняют друг друга: на бесплатной диагностике мы честно говорим, какой вариант подойдёт под вашу задачу — даже если это группа, а не более дорогие индивидуальные занятия. Подробнее о том, как устроены <a href=\"/repetitor\">индивидуальные занятия в Фоксинбурге</a>, — на отдельной странице: там цены, форматы и ответы на частые вопросы. Оценить текущую точку перед выбором формата поможет <a href=\"/test-uroven\">бесплатный тест уровня</a> и <a href=\"/diagnostika\">диагностика с методистом</a>."),
        ("p", "А если сомневаетесь между школой и частным репетитором в принципе — мы уже разбирали это в статье <a href=\"/novosti-yazykovaya-shkola-ili-repetitor-kak-vybrat\">«Языковая школа или репетитор для ребёнка»</a>: там сравнение по задачам, а не по ценнику. Решили, что индивидуальный формат нужен, — следующий шаг в статье «<a href=\"/blog-kak-vybrat-repetitora\">Как выбрать репетитора по английскому</a>»: по каким признакам отличить сильного педагога до первой оплаты."),
    ],
    "related": [
        ("Индивидуальные занятия (репетитор)", "/repetitor"),
        ("Репетитор или курсы: что выбрать", "/blog-repetitor-ili-kursy"),
    ...
    "faq": [
        ...
        ("Зачем нужен репетитор по английскому?", "Репетитор нужен там, где групповой формат упирается в потолок: цель с дедлайном (ОГЭ, ЕГЭ, переезд), заметный пробел в базе, стеснение, которое мешает говорить в группе, нестандартный график или узкая задача, которой нет в стандартной программе. Для «учить язык для жизни» обычно хватает мини-группы."),
        ("Что лучше: репетитор или курсы английского?", "Зависит от задачи: группа даёт живое общение и мотивацию дешевле, индивидуальный формат — точечную работу под цель. Мы сравнили оба варианта по задачам и бюджету в статье «<a href=\"/blog-repetitor-ili-kursy\">Репетитор или курсы английского: что выбрать</a>»."),
...
NEWS_POST_12 = {
    ...
    "title": "Набор на учебный год 2026/27 открыт — Фоксинбург",
    "description": "Запишитесь в группы Фоксинбурга на 2026/27 год: английский от 2 лет, подготовка к школе, ОГЭ и ЕГЭ, немецкий и китайский. Диагностика бесплатна.",
    "category": "Набор",
    "date": "2026-08-12",
    "reading_time": "6 минут чтения",
...
NEWS_POST_13 = {
    ...
    "title": "Как выбрать программу английского ребёнку: гид 2026",
    "description": "Выберите программу английского для ребёнка без ошибок: возраст, уровень, цель и формат — четыре шага и бесплатная диагностика перед стартом года.",
    "category": "Полезное для родителей",
    "date": "2026-08-14",
    "reading_time": "8 минут чтения",
    ...
    "body": [
        ...
        ("p", "В Фоксинбурге — <a href=\"/\">школе английского языка в Долгопрудном</a> — программа подбирается не «по возрасту из таблицы», а по результату бесплатной диагностики: методист смотрит уровень, характер и цель, а затем предлагает конкретную группу — <a href=\"/doshkolniki\">дошкольникам</a>, <a href=\"/mladshie-shkolniki\">младшим школьникам</a> или <a href=\"/podrostki\">подросткам</a>. Если сомневаетесь между двумя вариантами — это нормально: именно для этого и нужна диагностика, чтобы выбирать по факту, а не гадать. Записаться можно через <a href=\"/novosti-otkryt-nabor-na-novyj-uchebnyj-god-2026\">набор на новый учебный год</a> — он уже открыт. Общие критерии выбора школы собрали в гиде «<a href=\"/blog-kak-vybrat-shkolu-anglijskogo-v-dolgoprudnom\">Как выбрать школу английского в Долгопрудном</a>»."),
    ],
    "related": [
...
NEWS_POST_14 = {
    ...
    "title": "Как вернуть английский к сентябрю 2026 после каникул",
    "description": "Подготовьте ребёнка к учебному году без авралов: как за 10–15 минут в день вернуть английский после лета и выбрать группу до сентябрьского ажиотажа.",
    "category": "Полезное для родителей",
    "date": "2026-08-16",
    "reading_time": "7 минут чтения",
    ...
    "body": [
        ...
        ("p", "Типичная ситуация: семья ждёт начала учёбы, смотрит, как сложится школьное расписание, и только потом ищет занятия — а удобные группы к этому моменту уже набраны. Гораздо спокойнее определиться в августе: пройти диагностику, выбрать дни и время, при необходимости рассмотреть <a href=\"/online-zanyatiya\">онлайн-формат</a>, если логистика плотная. Быстро сориентироваться по уровню после лета поможет <a href=\"/test-uroven\">бесплатный онлайн-тест</a>. Тогда сентябрь начинается без лишней беготни — ребёнок просто приходит в свою группу."),
...
NEWS_POST_15 = {
    ...
    "title": "Старт учебного года 2026/27 в Фоксинбурге: что важно",
    "description": "Узнайте, как пройдёт старт 2026/27 учебного года в Фоксинбурге: знакомство с педагогом, диагностика без стресса и что успеть до первого занятия.",
    "category": "Новости школы",
    "date": "2026-08-18",
    "reading_time": "6 минут чтения",
    ...
    "body": [
        ...
        ("ul", [
            "Пройти <a href=\"/diagnostika\">бесплатную диагностику</a> и подтвердить место в группе — набор идёт, удобное время разбирают первым.",
        ...
        ("p", "Набор на новый учебный год продолжается: английский для детей от 2 лет, школьников и подростков, <a href=\"/nemeckij-yazyk\">немецкий</a> и <a href=\"/kitajskij-yazyk\">китайский</a>, <a href=\"/preparation\">подготовка к школе</a> и индивидуальные занятия. Оставьте заявку на сайте или напишите в Max — расскажем расписание, ответим на вопросы и запишем на диагностику. Подробности — в анонсе «<a href=\"/novosti-otkryt-nabor-na-novyj-uchebnyj-god-2026\">Открыт набор на новый учебный год</a>», а бонус ранней записи — в новости «<a href=\"/novosti-nabor-2026-2027\">Набор на 2026/27 учебный год открыт</a>». До встречи на занятиях!"),
    ],
    "related": [
        ("Набор на новый учебный год", "/novosti-otkryt-nabor-na-novyj-uchebnyj-god-2026"),
...
BLOG_POST_1 = dict(BLOG_FEED, **{
    ...
    "title": "Английский для малышей 3–4 лет: уроки в игровом формате",
    "description": "Английский для малышей 3–4 года: как проходит урок в игровом формате — песни, движение, мини-группы. Как не перегрузить ребёнка и заложить базу без зубрёжки.",
    "category": "Родителям",
    "date": "2026-08-01",
    "reading_time": "8 минут чтения",
    "hero_grad": "linear-gradient(135deg,#2e1a47 0%,#662d92 55%,#8a4fb8 100%)",
...
BLOG_POST_8 = dict(BLOG_FEED, **{
    ...
    "faq": [
        ...
        # Перенесено из закрытой статьи-дубля blog-onlajn-ili-offlajn (волна 21).
...
BLOG_POST_11 = dict(BLOG_FEED, **{
    ...
    "body": [
        ...
        ("p", "Эмоция — самый сильный клей для памяти. Слово «delicious» запомнится мгновенно, если ребёнок скажет его про любимое бабушкино варенье. Приём «расскажи про своё» работает с любой лексикой: учим цвета — описываем свою комнату, учим еду — вчерашний ужин, учим числа — рассказываем про возраст семьи (как это сделать по-английски — в статье «<a href=\"/blog-vozrast-na-anglijskom\">Как сказать возраст по-английски</a>»). На наших занятиях педагоги сознательно строят лексику вокруг жизни учеников: это не просто доброта методики, а работа с механикой памяти."),
...
BLOG_POST_12 = dict(BLOG_FEED, **{
    ...
    "related": [
        ...
        ("Present Simple для детей простыми словами", "/blog-present-simple-detyam"),
        ("Ребёнок не понимает английский в школе", "/blog-rebenok-ne-ponimaet-anglijskij-v-shkole"),
        ("Все статьи блога", "/blog"),
    ],
    "faq": [
...
BLOG_POST_14 = dict(BLOG_FEED, **{
    ...
    "description": "Цены на английский для детей в Долгопрудном: группы, индивидуальные занятия и пробный урок — из чего складывается цена и как вернуть 13% по вычету.",
    "category": "Родителям",
    "date": "2026-07-14",
    "reading_time": "7 минут чтения",
...
BLOG_POST_20 = dict(BLOG_FEED, **{
    ...
    "body": [
        ...
        ("p", "Группы нового учебного года уже сформированы — если вы ещё не с нами, пройдите диагностику, и мы подберём группу в удобном филиале (Лихачёвский 76к1 или Ракетостроителей 9к3). <a href=\"/letnyaya-akademiya\">Летняя академия</a> завершила сезон 2026 — следующие смены летом 2027. Программы на год — для всех возрастов: от <a href=\"/doshkolniki\">дошкольников</a> до <a href=\"/anglijskij-dlya-vzroslyh\">взрослых</a>; тарифы — на странице <a href=\"/tseny\">цен</a>. До встречи в сентябре!"),
    ],
    "related": [
...
BLOG_POST_21 = dict(BLOG_FEED, **{
    ...
    "description": "Как выбрать кружок английского для ребёнка 4–6 лет: на что смотреть на пробном, какие вопросы задать, красные флаги и признаки хорошей программы.",
    "category": "Родителям",
    "date": "2026-07-03",
    "reading_time": "8 минут чтения",
...
BLOG_POST_22 = dict(BLOG_FEED, **{
    ...
    "description": "План летнего английского для школьника: сколько минут в день достаточно, что эффективнее — слова, мультфильмы или чтение, и кому нужен интенсив.",
    "category": "Учим английский",
    "date": "2026-07-08",
    "reading_time": "8 минут чтения",
...
BLOG_POST_29 = dict(BLOG_FEED, **{
    ...
    "description": "Когда начинать готовиться к ОГЭ по английскому: оптимальный старт — 8 класс. План по классам (7, 8, 9) и 5 сигналов, что пора на курс.",
    "category": "Экзамены",
    "date": "2026-08-14",
    "reading_time": "8 минут чтения",
...
BLOG_POST_32 = dict(BLOG_FEED, **{
    ...
    "description": "В июне 2026 ученики Фоксинбурга побывали в Ю-Клинике и на пожарной станции. Зачем языковой школе экскурсии и что дети вынесли из выездов.",
    "category": "Родителям",
    "date": "2026-08-24",
    "reading_time": "5 минут чтения",
    "hero_grad": "linear-gradient(135deg,#123b2e 0%,#1d6f5c 55%,#c24712 100%)",
...
BLOG_POST_33 = dict(BLOG_FEED, **{
    ...
    "body": [
        ("video", {"kicker": "Видео из архива", "title": "Хеллоуин 2025 — как это было", "lead": "Короткий ролик с Хеллоуина в Фоксинбурге: костюмы, реквизит, игра и дети, которые говорят по-английски без страха. Как это было — фото и видео.", "src": "/media/life/2025-10-27-other/570690408558754058.mp4", "poster": "/media/life/2025-10-27-other/570690408558754058.poster.webp"}),
...
BLOG_POST_34 = dict(BLOG_FEED, **{
    ...
    "body": [
        ("video", {"kicker": "Видео из архива", "title": "Новый год 2026 — фрагмент праздника", "lead": "Ёлка, Дед Мороз и праздничная программа на английском — как прошёл Новый год 2026 в Фоксинбурге. Реальные фото и видео праздника.", "src": "/media/life/2025-12-20-other/9197161958741947074.mp4", "poster": "/media/life/2025-12-20-other/9197161958741947074.poster.webp"}),
...
BLOG_POST_35 = dict(BLOG_FEED, **{
    "type": "article",
    "alias": "blog-probely-po-anglijskomu",
    "title": "Пробелы по английскому языку в 3, 4 и 5 классе: как найти и закрыть",
    "description": "Пробелы по английскому в 3–5 классе: как распознать по домашке и оценкам, чек-лист тем по классам и план, как закрыть пробелы за 2–3 месяца.",
    "category": "Школа и учёба",
    "date": "2026-08-26",
    "reading_time": "9 минут чтения",
    "hero_grad": "linear-gradient(135deg,#1e1433 0%,#4a2a7a 55%,#8a4fb8 100%)",
    "body": [
        ("h2", "Откуда вообще берутся пробелы по английскому"),
        ("p", "Английский в начальной школе строится «лесенкой»: каждая следующая тема опирается на предыдущую. Если в 3 классе ребёнок не освоил глагол <b>to be</b> и базовое чтение по правилам, в 4 классе «посыплются» времена, а в 5 классе — почти всё: чтение текстов, перевод, грамматика. Поэтому пробелы по английскому почти никогда не «вылезают» сразу — они копятся незаметно и проявляются через год-полтора, когда догонять уже тяжело."),
        ("p", "Типичные причины: пропуски из-за болезней, большой класс, где педагог физически не может проверить каждого, зубрёжка без понимания («выучил диалог — забыл через неделю»), смена педагога или учебника и, честно говоря, просто слабый интерес — ребёнок учит «для галочки». Важно: пробелы — это не про способности ребёнка. Это почти всегда про конкретные пропущенные темы, которые можно найти и закрыть."),
        ("h2", "Как распознать пробелы: 7 сигналов"),
        ("ul", [
            "домашка по английскому занимает час и больше, хотя задание — полстраницы;",
            "ребёнок читает по-русски, «как слышится» (shool вместо school), а не по правилам;",
            "путает am/is/are и was/were даже в простых предложениях;",
            "переводит предложения слово за словом, теряя порядок слов английского языка;",
            "не может пересказать прочитанное даже по-русски — читал «механически»;",
            "оценки «плавают»: 4–5 за заученный диалог и 2–3 за любое задание «на подумать»;",
            "прячет тетрадь, отговаривается от проверки слов, говорит «нам это не задавали».",
        ]),
        ("p", "Если узнали 2–3 сигнала — это повод не ругать, а провести ревизию тем. Самый честный тест: откройте учебник на оглавлении и пройдитесь по темам прошлого года. То, что ребёнок не может объяснить своими словами, и есть пробел."),
        ("h2", "Чек-лист: что должен знать ребёнок по классам"),
        ("h3", "К концу 3 класса"),
        ("ul", [
            "читать короткие слова и простые предложения по базовым правилам чтения;",
            "глагол to be (am/is/are) в утверждении, отрицании и вопросе;",
            "конструкция have got / has got;",
            "местоимения (я, ты, он, она…) и притяжательные (мой, твой, его…);",
            "базовый запас слов по школьным темам: семья, школа, животные, еда, цвета, числа.",
        ]),
        ("h3", "К концу 4 класса"),
        ("ul", [
            "Present Simple: окончание -s в 3-м лице, do/does в вопросах и отрицаниях;",
            "Present Continuous: «что происходит сейчас» — и отличие от Present Simple;",
            "Past Simple хотя бы на частых глаголах (was/were, went, had, saw);",
            "наречия частоты (always, usually, sometimes, never) и их место в предложении;",
            "чтение и понимание короткого текста без словаря.",
        ]),
        ("h3", "К концу 5 класса"),
        ("ul", [
            "уверенно различать три времени: Present Simple, Present Continuous, Past Simple;",
            "множественное число существительных, включая исключения;",
            "базовые предлоги времени и места (in, on, at, under, next to);",
            "связный рассказ о себе, семье, дне — 8–10 предложений;",
            "понимание на слух коротких диалогов в школьном темпе.",
        ]),
        ...
        ("ul", [
            "<b>Диагностика.</b> Часовая проверка по чек-листу выше: чтение вслух, 10 предложений на грамматику, короткий пересказ. Фиксируем список конкретных тем — обычно их 3–6, а не «всё плохо».",
            "<b>Приоритет фундамента.</b> Сначала чтение и to be / Present Simple — без них не заработает ничего дальше. На «красивые» темы (времена ради времён) в это время не тратим силы.",
            "<b>Короткая ежедневная практика.</b> 15–20 минут каждый день бьют по эффекту два долгих занятия в неделю: слова на карточках, одна грамматическая тема в неделю, чтение вслух по 5 минут.",
            "<b>Закрепление в речи.</b> Каждую разобранную тему ребёнок должен использовать: составить 5 своих предложений, ответить на вопросы, пересказать. Без этого правило снова «испарится».",
            "<b>Контроль раз в 2 недели.</b> Короткая проверка пройденного — и возврат к тому, что не закрепилось. Пробелы считаются закрытыми, когда тема выдержала две проверки подряд.",
        ]),
        ("p", "По опыту на видимое изменение уходит 2–3 месяца регулярной работы: домашка начинает делаться быстрее, оценки выравниваются, ребёнок перестаёт бояться урока. Залог — не интенсивность, а регулярность."),
        ("h2", "Что можно сделать прямо сегодня: план на неделю"),
        ("ul", [
            "<b>День 1.</b> Ревизия по оглавлению учебника: отметьте темы, которые ребёнок не может объяснить.",
            "<b>День 2.</b> 10 минут чтения вслух — оцените, читает по правилам или «как слышится».",
            "<b>День 3.</b> 10 предложений с am/is/are — устно, на ходу, про свою семью.",
            "<b>День 4.</b> Карточки: 10 слов из прошлогодних тем — сколько помнит без подсказки?",
            "<b>День 5.</b> Пересказ короткого текста из учебника сначала по-русски, потом 3–4 фразы по-английски.",
            "<b>День 6–7.</b> Повторение всего, что «посыпалось» в дни 1–5 — и список тем для работы готов.",
        ]),
        ("h2", "Когда нужна помощь педагога"),
        ("p", "Домашняя работа отлично закрывает пробелы, если их немного и у родителей есть время и терпение. Но есть ситуации, где самостоятельно справиться сложно: пробелы затрагивают чтение и грамматику одновременно (это уже «системная» история), ребёнок демотивирован и сопротивляется любым занятиям дома, или впереди ВПР/переход в старшую школу и времени на раскачку нет. В этих случаях быстрее и дешевле по нервам — короткий курс с педагогом, который умеет именно ликвидировать пробелы, а не «проходить программу»."),
        ("p", "В Фоксинбурге мы начинаем с бесплатной диагностики: за 30–40 минут педагог проверяет чтение, грамматику и словарный запас и показывает родителям конкретную карту пробелов — как в чек-листе выше. Дальше предлагаем формат: <a href=\"/repetitor\">индивидуальные занятия</a> для точечной ликвидации тем, <a href=\"/repetitor-nachalnaya-shkola\">репетитор для 1–4 класса</a> или мини-группу по уровню — <a href=\"/mladshie-shkolniki\">для младших школьников</a> и <a href=\"/podrostki\">для подростков</a>. Честно скажем, если хватит и домашней работы — и подскажем, как её построить."),
        ("h2", "Частые вопросы про пробелы по английскому"),
        ("p", "<b>«Ребёнок в 3 классе ничего не понимает в английском — это нормально?»</b> Нет, но это поправимо: в 3 классе объём материала ещё небольшой, и при регулярной работе пробелы закрываются за 1–2 месяца. Хуже всего ждать, что «само рассосётся», — программа 4–5 класса только ускорится."),
        ("p", "<b>«Можно ли закрыть пробелы за лето?»</b> Да, лето — идеальное время: без школьной нагрузки 3 занятия в неделю дают заметный результат за 2 месяца. Многие семьи используют для этого наши летние программы."),
        ("p", "<b>«У нас в 4 классе проблемы и с русским тоже — с чего начать?»</b> Начните с чтения — оно общее для обоих языков. Параллельно посмотрите нашу страницу <a href=\"/repetitor-nachalnaya-shkola\">подготовки и поддержки по начальной школе</a>: там как раз формат для таких ситуаций."),
    ],
    "related": [
        ("Репетитор 1–4 класс", "/repetitor-nachalnaya-shkola"),
        ("Индивидуальные занятия", "/repetitor"),
        ("Английский в 5 классе: что ждать", "/blog-anglijskij-v-5-klasse-chto-zhdat"),
        ("Все статьи блога", "/blog"),
    ],
    "faq": [
        ("Как понять, что у ребёнка пробелы именно по английскому, а не просто лень?", "Лень проходит, когда задание по силам. Пробел — когда ребёнок не может выполнить задание прошлогодней программы даже с вашей помощью: не читает по правилам, путает am/is/are, не понимает прочитанное. Проверьте по чек-листу тем за прошлый год — это займёт 20 минут."),
        ("За какое время реально закрыть пробелы по английскому?", "При регулярной работе (15–20 минут в день дома или 2 занятия в неделю с педагогом) видимый результат — 2–3 месяца: домашка делается быстрее, оценки выравниваются. Полностью «догнать и перегнать» программу — обычно за полгода."),
        ("С чего начинать: с грамматики, слов или чтения?", "С чтения и базовой грамматики (to be, Present Simple) — это фундамент, на котором держится всё остальное. Слова учатся параллельно, карточками по 5–10 в день. Красивые и сложные темы оставьте на потом."),
        ("Поможет ли репетитор, или справимся дома?", "Если пробелов 2–3 темы и у вас есть 20 минут в день — справитесь дома по плану из статьи. Если пробелы системные (чтение + грамматика), ребёнок сопротивляется или впереди ВПР — быстрее с педагогом. Начните с бесплатной диагностики: получите карту пробелов и честную рекомендацию."),
    ],
})
...
import pages_words3  # регистрирует 5 новых тем словаря (волна 6) в PAGES при импорте
import pages_prep
...
import pages_wave15  # волна 15: лендинг-витрина /kursy-v-dolgoprudnom
...
PAGES["page_blog_probely_po_anglijskomu.html"] = BLOG_POST_35
