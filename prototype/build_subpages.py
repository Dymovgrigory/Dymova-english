...
PAGES["page_doshkolniki.html"] = {
    ...
    "prices": True,
    "price_cards": [
        ("Группа", "", '9 000 ₽<span>/мес</span>', "2 занятия в неделю · 45 минут (2–3 года) или 60 минут (4–6 лет) · мини-группа"),
        ("Индивидуально", " fxb-price-tag--orange", '2 500 ₽<span>/час</span>', "Индивидуальный темп и гибкий график"),
        ("Пробный урок", "", "1 125 ₽", "Знакомство с педагогом и подбор формата"),
    ],
    "extra_sections": [
...
PAGES["page_preparation.html"] = {
    ...
    "faq": [
        ...
        ("В каком возрасте начинать?", "Основные группы — 4–5 и 6–7 лет. Точный старт подскажем после бесплатной диагностики готовности к школе."),
...
PAGES["page_geo_mytishchi.html"] = {
    ...
    "extra_sections": [
        ...
        "<ul>"
        '<li><a href="/preparation">Подготовка к школе</a> для детей 4–7 лет — чтение, математика, русский язык, 7 000 ₽/мес;</li>'
