...
PAGES["page_anglijskij_dlya_vzroslyh.html"] = {
    ...
    "faq": [
        ...
        ("Подойдёт ли курс для работы и путешествий?", "Да. Программа подстраивается под цель: английский для работы (письма, звонки, собеседования) и английский для путешествий (аэропорт, отель, общение в поездке) — скажите цель на диагностике, и мы выстроим маршрут."),
...
EXTRA_BLOG_POSTS = pages_wave16.WAVE16_POSTS + pages_wave11.WAVE11_POSTS + pages_wave10.WAVE10_POSTS + pages_wave7.WAVE7_POSTS + pages_wave5.WAVE5_POSTS + pages_drafts.DRAFT_POSTS + pages_prep.PREP_POSTS + pages_lang_news.LANG_POSTS + pages_lang_news.BLOG_MISC_POSTS
