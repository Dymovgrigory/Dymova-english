...
PAGES["page_repetitor_nachalnaya_shkola.html"] = {
    ...
    "sub": "Индивидуальные занятия по школьным предметам в Долгопрудном: подтянем русский язык и математику, научим учиться и вернём ребёнку уверенность.",
    "cta_label": "Записаться на диагностику",
    "feat_kicker": "Чем занимаемся",
    ...
    "features": [
        ...
        ("target", "Подтягивание программы", "Находим пробелы на диагностике и закрываем их в индивидуальном темпе."),
    ],
    "facts_title": "Коротко о занятиях",
    "facts": [
        ("cap", "1–4 класс", "Начальная школа"),
        ("chat", "1 на 1", "Индивидуально с педагогом"),
        ("calendar", "Гибкий график", "Расписание под вашу неделю"),
        ("compass", "Очно и онлайн", "Два филиала и онлайн-формат"),
    ],
    "formats_title": "Форматы занятий",
    "formats_lead": "Занятия проходят индивидуально — очно в филиалах Долгопрудного или онлайн.",
    "formats": [
        ("compass", "Очно в двух филиалах", "Занятия в Долгопрудном — на Лихачевского, 76к1 и на Ракетостроителей, 9к3."),
        ("monitor", "Онлайн с педагогом", "Живые видеоуроки для тех, кому удобнее заниматься из дома."),
        ("chat", "Индивидуально 1 на 1", "Педагог занят только вашим ребёнком — темп и программа под его пробелы."),
    ...
    "prices": True,
    "price_title": "Стоимость занятий",
    "price_lead": "Индивидуальные занятия по русскому языку и математике для 1–4 классов — 5 600 ₽/мес.",
    "price_cards": [
        ("Месяц занятий", "", '5 600 ₽<span>/мес</span>', "Русский язык и математика · 1–4 класс · индивидуально с педагогом"),
    ],
    "adv_title": 'Почему выбирают <span class="fxb-accent">Фоксинбург</span>',
    "adv_lead": "Языковая школа в Долгопрудном с 2020 года — с лицензией, своей методикой и вниманием к каждому ученику.",
    "advantages": [
        ("shield", "Лицензия и опыт с 2020 года", "Официальная образовательная лицензия и годы практики в обучении детей и взрослых."),
        ("check", "Маткапитал и налоговый вычет", "Занятия можно оплатить материнским капиталом и вернуть 13% стоимости налоговым вычетом."),
        ("target", "Индивидуальный план", "Занятия 1 на 1: программа строится под пробелы и темп конкретного ребёнка."),
        ("chart", "Видимый прогресс", "Регулярные отчёты родителям — видно, что изменилось и что дальше."),
        ("monitor", "Оффлайн и онлайн", "Два филиала в Долгопрудном рядом с МФТИ и удобный онлайн-формат — как вам удобно."),
        ("star", "Рейтинг 4,8", "Высокие оценки родителей на картах и в отзывах — нам доверяют детей."),
    ],
    ...
    "faq": [
        ...
        ("Сколько стоят занятия?", "Индивидуальные занятия по русскому языку и математике для 1–4 классов — 5 600 ₽/мес. Перед стартом — бесплатная диагностика."),
        ("Можно ли заниматься онлайн?", "Да. Занятия доступны очно в Долгопрудном (два филиала рядом с МФТИ) и онлайн — формат можно менять."),
...
PAGES["page_novosti.html"] = {
    ...
    "articles": [NEWS_POST_11, NEWS_POST_10, NEWS_POST_9, NEWS_POST_8, NEWS_POST_7, NEWS_POST_6, NEWS_POST_5, NEWS_POST_4, NEWS_POST_3, NEWS_POST_2, NEWS_POST_1],
}
