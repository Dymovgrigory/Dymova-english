...
PAGES["page_meropriyatiya.html"] = {
    ...
    "sub": "Мастер-классы, киновечеринки на английском, сезонные Академии и праздники — языковая среда за пределами урока. Для учеников мероприятия входят в абонемент.",
    "cta_label": "Записаться на диагностику",
    ...
    "facts": [
        ...
        ("heart", "Входят в абонемент", "Для учеников — без доплат"),
    ...
    "faq": [
        ...
        ("Мероприятия платные?", "Для учеников школы мероприятия входят в абонемент — доплачивать не нужно. Промо-мероприятия в парках Долгопрудного бесплатны и открыты для всех."),
    ...
    "extra_jsonld": [
        webpage_jsonld(
            ...
            "Мероприятия Фоксинбурга в Долгопрудном: мастер-классы, киновечеринки на английском, сезонные Академии, новогодние праздники и открытые занятия в парках. Для учеников входят в абонемент.",
            SITE + "/meropriyatiya",
        ),
        breadcrumb_jsonld([
            ("Главная", SITE + "/"),
