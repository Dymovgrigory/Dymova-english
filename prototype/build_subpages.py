...
BLOG_POST_35 = dict(BLOG_FEED, **{
    ...
    "description": "Пробелы по английскому в 3–5 классе: откуда берутся, как распознать по домашке и оценкам, чек-лист тем по классам и рабочий план, как закрыть пробелы за 2–3 месяца.",
    "category": "Школа и учёба",
    "date": "2026-08-26",
    "reading_time": "9 минут чтения",
    "hero_grad": "linear-gradient(135deg,#1e1433 0%,#4a2a7a 55%,#8a4fb8 100%)",
