...
PAGES["page_repetitor.html"] = {
    ...
    "faq": [
        ...
        ("А занимаетесь только английским?", "Нет. У нас также есть <a href=\"/repetitor-nachalnaya-shkola\">репетитор по русскому языку и математике для 1–4 классов</a> — 5 600 ₽/мес, а также <a href=\"/preparation\">подготовка к школе</a> для дошкольников."),
    ],
...
PAGES["page_repetitor_nachalnaya_shkola.html"] = {
    ...
    "prices": True,
    "price_title": "Стоимость занятий",
    "price_lead": "Групповые очные занятия по русскому языку и математике для 1–4 классов — 5 600 ₽/мес.",
    "price_cards": [
        ("Месяц занятий", "", '5 600 ₽<span>/мес</span>', "Русский язык и математика · 1–4 класс · мини-группа до 7 человек · очно"),
    ],
    "adv_title": 'Почему выбирают <span class="fxb-accent">Фоксинбург</span>',
    "adv_lead": "Языковая школа в Долгопрудном с 2020 года — с лицензией, своей методикой и вниманием к каждому ученику.",
    "advantages": [
    ...
    "faq": [
        ...
        ("Сколько стоят занятия?", "Групповые очные занятия по русскому языку и математике для 1–4 классов (мини-группы до 7 человек) — 5 600 ₽/мес. Перед стартом — бесплатная диагностика."),
...
PAGES["page_razgovornyj_anglijskij.html"] = {
    ...
    "extra_jsonld": [
        course_jsonld(
            ...
            "Разговорный английский в Долгопрудном для подростков и взрослых: коммуникативная методика, speaking club, преодоление языкового барьера. Мини-группы 6–8 человек и индивидуально, очно и онлайн. Диагностика бесплатно.",
...
PAGES["page_test_gotov_k_shkole.html"] = {
    ...
    "extra_jsonld": [
        webpage_jsonld(
            ...
            "Бесплатный онлайн-тест готовности ребёнка к школе от Фоксинбурга: 12 вопросов по вниманию, речи, моторике, логике и самостоятельности. Мгновенный результат, рекомендации, диагностика с педагогом в Долгопрудном — бесплатно.",
...
PAGES["page_otzyvy.html"] = {
    ...
    "extra_sections": [
        ...
        "<p>Мы не публикуем здесь чужие тексты дословно — полные отзывы читайте в карточках на Яндекс.Картах (ссылки ниже). А вот темы, которые родители и ученики упоминают чаще всего:</p>"
        "<ul>"
        "<li><b>Подготовка к ЕГЭ.</b> Родители выпускников отмечают системную подготовку и уверенность учеников на экзамене — об этом и наша страница <a href=\"/ege-anglijskij\">подготовки к ЕГЭ</a>.</li>"
        "<li><b>Домашние задания перестали быть проблемой.</b> Дети делают задания без напоминаний — формат и приложение с наградами делают своё дело.</li>"
        "<li><b>Дети ходят с удовольствием.</b> Самая частая фраза в отзывах о детских группах — ребёнок не просто ходит, а просится на занятия.</li>"
        "<li><b>Видимый прогресс.</b> Родители ценят ежемесячные отчёты педагога: видно, что изменилось и что дальше.</li>"
        "</ul>"
...
PAGES["page_about.html"] = {
    ...
    "extra_jsonld": [
        webpage_jsonld(
            ...
            "Языковая школа Фоксинбург в Долгопрудном: работаем с 2020 года, основатель Дымова Вероника Александровна. Английский, немецкий и китайский для детей и взрослых, подготовка к ВПР/ОГЭ/ЕГЭ. 2 филиала, рейтинг 5,0, награда «Хорошее место 2026».",
            SITE + "/about",
        ),
        breadcrumb_jsonld([
            ("Главная", SITE + "/"),
...
BLOG_POST_30 = dict(BLOG_FEED, **{
    ...
    "faq": [
        ...
        ("Сколько стоит участие в праздниках?", "Для учеников школы большинство событий входит в абонемент, отдельные праздники оплачиваются дополнительно по символической цене. Точные условия публикуются в анонсе каждого события."),
...
PAGES["page_blog.html"] = {
    ...
    "articles": BLOG_POSTS_NEW3 + BLOG_POSTS_NEW + BLOG_POSTS,
    "extra_jsonld": [
        webpage_jsonld(
            "CollectionPage",
