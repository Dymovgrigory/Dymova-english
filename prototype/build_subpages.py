...
NEWS_POST_12 = {
    ...
    "description": "Фоксинбург открывает набор на новый учебный год: английский, немецкий и китайский для детей от 2 лет, подростков и взрослых. Как формируются группы.",
    "category": "Набор",
    "date": "2026-08-12",
    "reading_time": "6 минут чтения",
...
NEWS_POST_13 = {
    ...
    "description": "Возраст, уровень, цели и формат — из чего складывается выбор программы английского и почему «самая сильная» не всегда лучшая для вашего ребёнка.",
    "category": "Полезное для родителей",
    "date": "2026-08-14",
    "reading_time": "8 минут чтения",
...
import pages_wave5
import pages_wave7  # бренд-защита: гид по выбору школы английского в Долгопрудноме
