...
PAGES["page_doshkolniki.html"] = {
    ...
    "facts": [
        ...
        ("sun", "Вечерние группы", "Занятия после детского сада"),
    ...
    "faq": [
        ...
        ("Есть ли занятия после детского сада?", "Да, работают вечерние группы — ребёнок успевает прийти после сада. Точное расписание подберём на диагностике."),
...
PAGES["page_standartnye_offline.html"] = {
    ...
    "faq": [
        ...
        ("Ребёнок учится во вторую смену — есть занятия утром?", "Да, есть утренние группы специально для тех, кто учится во вторую смену."),
