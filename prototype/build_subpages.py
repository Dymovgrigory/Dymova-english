...
PAGES["page_oge_anglijskij.html"] = {
    ...
    "formats_lead": "Выбирайте удобный формат подготовки к экзамену — очно или онлайн, в группе или индивидуально.",
    "formats": [
...
PAGES["page_ege_anglijskij.html"] = {
    ...
    "formats_title": "Форматы занятий",
    "formats_lead": "Подбираем формат под цель и темп подготовки — очно, онлайн, в группе или индивидуально.",
    "formats": [
        ("compass", "Очно в двух филиалах", "Занятия в Долгопрудном — на Лихачевского, 76к1 и на Ракетостроителей, 9к3."),
...
PAGES["page_novosti.html"] = {
    ...
    "articles": [NEWS_POST_10, NEWS_POST_9, NEWS_POST_8, NEWS_POST_7, NEWS_POST_6, NEWS_POST_5, NEWS_POST_4, NEWS_POST_3, NEWS_POST_2, NEWS_POST_1],
}
