...
BLOG_POST_29 = dict(BLOG_FEED, **{
    ...
    "description": "Оптимальные сроки подготовки к ОГЭ по английскому: что делать в 7, 8 и 9 классе, когда нужен курс, а когда хватает самостоятельной работы.",
    "category": "Экзамены",
    "date": "2026-08-14",
    "reading_time": "8 минут чтения",
...
EXTRA_BLOG_POSTS = pages_wave7.WAVE7_POSTS + pages_wave5.WAVE5_POSTS + pages_drafts.DRAFT_POSTS + pages_prep.PREP_POSTS + pages_lang_news.LANG_POSTS + pages_lang_news.BLOG_MISC_POSTS
