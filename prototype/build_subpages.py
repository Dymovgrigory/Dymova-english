...
NEWS_POST_11 = {
    ...
    "description": "Поймите, нужен ли репетитор по английскому именно вашему ребёнку: 5 ситуаций, где индивидуальные занятия окупаются быстрее всего, и когда хватит мини-группы.",
    "category": "Экспертное мнение",
    "date": "2026-08-10",
    "reading_time": "6 минут чтения",
