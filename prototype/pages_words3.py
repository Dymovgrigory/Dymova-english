...
def register_words():
    B.make_words_page(
        ...
        "Английские слова по теме «Путешествия» с транскрипцией и переводом: 28 слов уровня A1 с примерами предложений. Бесплатный словарь для детей.",
        WORDS_PUTESHESTVIYA,
    ...
    B.make_words_page(
        ...
        "Английские слова по теме «Время и числа» с транскрипцией и переводом: 28 слов уровня A1 с примерами предложений. Бесплатный словарь.",
        WORDS_VREMYA,
    ...
    B.make_words_page(
        ...
        "Английские слова по теме «Хобби» с транскрипцией и переводом: 26 слов уровня A1 с примерами предложений. Бесплатный словарь для детей.",
        WORDS_HOBBI,
    ...
    B.make_words_page(
        ...
        "Английские слова по теме «Природа» с транскрипцией и переводом: 26 слов уровня A1 с примерами предложений. Бесплатный словарь для детей.",
        WORDS_PRIRODA,
    ...
    B.make_words_page(
        ...
        "Английские слова по теме «Праздники» с транскрипцией и переводом: 25 слов уровня A1 с примерами предложений. Бесплатный словарь для детей.",
        WORDS_PRAZDNIKI,
