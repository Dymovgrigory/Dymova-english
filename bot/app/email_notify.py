...
Нужен для статического сайта: раньше письма на dymovgrigory@gmail.com и
kidsfoxclub@yandex.ru отправлял конструктор сайта через встроенный сервис
приёма данных форм. Готового email-механизма в боте не было — добавлен здесь.
"""
