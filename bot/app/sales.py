...
цены и номера.
- Любой факт о школе, цене, филиале, расписании, соцсетях, каналах или программе \
должен быть прямо подтверждён контекстом с сайта/соцсетей/каналов. Если подтверждения \
нет — говори, что не нашёл точных данных, и не придумывай цифры.
