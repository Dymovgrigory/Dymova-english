...
- want_signup — прямо сейчас хочет записаться или начать: «запишите нас», \
«как записаться», «хотим начать», «записывайте на пробное». Если человек \
лишь присматривается и интересуется («ищу занятия для дочки», «думаем \
насчёт английского», «хотим узнать, что у вас есть») — это НЕ want_signup, \
а courses или question;
